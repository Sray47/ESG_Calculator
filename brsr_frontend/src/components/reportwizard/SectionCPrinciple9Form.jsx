            ...
            <div className="form-group">
                <label>2. Turnover of products and/ services as a percentage of turnover from all products/service that carry information about:</label>                <div style={{ marginLeft: '20px' }}>
                    ...
                    <input 
                        ...
                        disabled={disabled} 
                        placeholder="%"
                        style={{borderColor: validationErrors['essential_indicators.turnover_product_services_info.environmental_social_parameters_turnover_percent'] ? '#f44336' : ''}}
                    />
                    ...
                    <input 
                        ...
                        disabled={disabled} 
                        placeholder="%"
                        style={{borderColor: validationErrors['essential_indicators.turnover_product_services_info.safe_responsible_usage_turnover_percent'] ? '#f44336' : ''}}
                    />
                    ...
                    <label>Recycling and/or safe disposal (As a percentage to total turnover):</label>                    <input 
                        ...
                        disabled={disabled} 
                        placeholder="%"
                        style={{borderColor: validationErrors['essential_indicators.turnover_product_services_info.recycling_disposal_turnover_percent'] ? '#f44336' : ''}}
                    />
                            ...
                            <tr key={item.category}>
                                ...
                                <td>
                                    <input 
                                        ...
                                        disabled={disabled} 
                                        min="0"
                                        style={{borderColor: validationErrors[`complaint_${item.category}_received`] ? '#f44336' : ''}}
                                    />
                                ...
                                <td>
                                    <input 
                                        ...
                                        disabled={disabled} 
                                        min="0"
                                        style={{borderColor: validationErrors[`complaint_${item.category}_pending`] ? '#f44336' : ''}}
                                    />
            ...
            <div className="form-group">
                ...
                <div style={{ marginLeft: '20px' }}>                    <label>Voluntary recalls - Number:</label>
                    <input 
                        ...
                        disabled={disabled}
                        style={{borderColor: validationErrors['essential_indicators.product_recalls_safety.voluntary_recalls.number'] ? '#f44336' : ''}}
                    />
                    ...
                    <input 
                        ...
                        disabled={disabled}
                        style={{borderColor: validationErrors['essential_indicators.product_recalls_safety.forced_recalls.number'] ? '#f44336' : ''}}
                    />
            ...
            <div className="form-group">
                ...
                {formData.essential_indicators.cyber_security_data_privacy_policy?.has_policy && (
                 ...
                 <input 
                    ...
                    disabled={disabled} 
                    placeholder="%"
                    style={{borderColor: validationErrors['essential_indicators.cyber_security_data_privacy_policy.cybersecurity_investment_percent_revenue'] ? '#f44336' : ''}}
                />
            ...
            <div className="form-group">
                ...
                <div style={{ marginLeft: '20px' }}>
                    ...
                    <input 
                        ...
                        disabled={disabled} 
                        placeholder="%"
                        style={{borderColor: validationErrors['leadership_indicators.data_breaches_info.percentage_involving_pii'] ? '#f44336' : ''}}
                    />
